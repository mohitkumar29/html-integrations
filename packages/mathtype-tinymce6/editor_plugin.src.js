...
export class TinyMceIntegration extends IntegrationModel {
  ...
  callbackFunction() {
    ...
    console.log(this.editorObject.images_dataimg_filter)

    console.log('try to get image');
    console.log(this.editorObject.dom)
    console.log(this.editorObject.dom.getContentEditable)
    console.log(this.editorObject.dom.get('img'))
  ...
  tinymce.PluginManager.add('example', (editor, url) => {
    ...
    return {
      init(editor) {
        ...
        console.log(editor)
        console.log(editor.getElement('extended_valid_elements'));

       // console.log(extended_valid_elements);
        ...
        const onInit = function (editor) { // eslint-disable-line no-shadow
          ...
          console.log(content);
          console.log(editor.getParam('language'))
          console.log(Parser.initParse(content, 'en'))
